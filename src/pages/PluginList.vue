    ...
    >
      ...
      <div class="row q-pb-xl q-pt-sm text-center q-col-gutter-lg" v-else>
        <div class="col-6" v-for="(i, index) in listOne">
          <div
            class="changeO q-px-sm text-subtitle1"
            :class="{ active: sort == index }"
            @click="select(index)"
          >
            {{ i.text }}
      ...
      <div class="row q-col-gutter-xl q-pt-sm">
        <div
        ...
        >
          <q-chip
            ...
            text-color="white"
            label="置顶"
            style="position:absolute;top:50px;left:30px;z-index:999"
          />
          <q-chip
            square
            v-if="i.ca_tag == 2"
          ...
          >
            <q-img :src="i.ca_cover_image" :ratio="16 / 9" />
            <div>
